...
Второе: назначьте ответственного за цифровые проекты и заведите реестр систем. Теперь у темы есть хозяин — и у самой ИИ-услуги тоже, не только у сервера<sup>129</sup>.
