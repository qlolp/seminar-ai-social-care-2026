...
**Документы (А):** приказ с регламентом (приложение 3), список допущенных сервисов, журнал инцидентов. Если помощник не только пишет черновик, а ещё отправляет или правит — в том же приказе матрица: что нельзя, что человек подтверждает, что можно. Журнал этих решений потом и проверяют<sup>99</sup>.
