...
**Рекомендация.** В цикле этого раздела разбор наставника остаётся решающим. Оценка модели — черновик, не аттестация (раздел 14.4). Цифровая гигиена та же, что в обучении смены: факты с ценой ошибки открывают по источнику; точку остановки задают заранее (раздел 19.4)<sup>114</sup>.
