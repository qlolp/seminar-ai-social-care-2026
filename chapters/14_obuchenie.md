...
**Факт.** Второй ИИ-«проверяющий» в генераторе учебных заданий переложил верный ответ в неверный: код читал короткое поле, а в объяснении модель сама приходила к правильному написанию. Тема до учеников не дошла — остановил не «машинный», а человек и формальный стоп. Урок переносится на проверку документов и заданий в соцсфере: автоматической проверке без человека или эталона не верят<sup>113</sup>.

**Рекомендация.** В цикле этого раздела разбор наставника остаётся решающим. Оценка модели — черновик, не аттестация (раздел 14.4). Цифровая гигиена та же, что в обучении смены: факты с ценой ошибки открывают по источнику; точку остановки задают заранее (раздел 19.4)<sup>114</sup>. Правку учебных карточек сверяют целиком: имена на месте не значат, что «кто кому» живо (раздел 9.5)<sup>120</sup>. Агент-опросник и тренажёр — продолжение наставника, не его замена (раздел 19.2)<sup>123</sup>.
