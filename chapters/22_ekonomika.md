...
**Факт.** KPI по токенам и «доле дней с ИИ» легко накрутить и не связаны с тем, что дошло до пользователя. Считают цену принятого результата, не объём сожжённого текста<sup>124</sup>.

**Факт.** По 1352 кейсам РФ в продакшене спрашивают не «какая модель», а что стоит между моделью и данными и где порог, за которым человек. Пилот без метрики до ИИ денег не даёт. Суммы в каталоге — самоотчёт компаний, не аудит<sup>130</sup>.
