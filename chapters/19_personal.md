...
**Интерпретация.** Модель без обвязки — малая доля результата. Регламент, человек на приёмке, журнал — и есть экосистема. Без людей, которые умеют утверждать черновик, копилот в коридоре не работает<sup>125</sup>.
