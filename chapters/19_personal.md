...
**Рекомендация.** Тот же порядок — для любого помощника рядом с журналами и карточками: прочитать можно, изменить — только после того, как человек подтверждает конкретное действие, человек решает. Платформу и методологию не копируем.
