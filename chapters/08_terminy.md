...
## 8.2. Ещё несколько терминов — для договоров и совещаний
...
**MCP (протокол контекста модели)** — способ подключить агента к чужим инструментам без своего кода. *Контрольный вопрос вендору:* кто проверил этот сервер и что агент не может сделать без человека? Первый попавшийся MCP — как флешка с пола (раздел 21.6)<sup>126</sup>.
