...
**Рекомендация.** К вопросам вендору добавьте два: что агент не может сделать, пока человек не подтвердит, и куда ему запрещён выход в сеть. Срез прав до поиска по своим файлам — раздел 9.7а.
